...
function stella_setup()
{
    ...
    register_nav_menus(
        array(
            'Top-menu' => esc_html__('Top-Header', 'stella'),
            'Primary-menu' => esc_html__('Primary', 'stella'),
            'Footer-menu' => esc_html__('Footer', 'stella'),
        )
    );
...
function stella_scripts()
{
    ...
    wp_enqueue_script('jquery', get_template_directory_uri() . '/js/jquery.js', array('jquery'), _S_VERSION, true);
    wp_enqueue_script('popper', get_template_directory_uri() . '/js/popper.min.js', array('jquery'), _S_VERSION, true);
    wp_enqueue_script('jquery-ui', get_template_directory_uri() . '/js/jquery-ui.js', array('jquery'), _S_VERSION, true);
    wp_enqueue_script('bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', array('jquery'), _S_VERSION, true);
    wp_enqueue_script('jquery.fancybox', get_template_directory_uri() . '/js/jquery.fancybox.js', array('jquery'), _S_VERSION, true);
    wp_enqueue_script('isotope', get_template_directory_uri() . '/js/isotope.js', array('jquery'), _S_VERSION, true);
    wp_enqueue_script('owl', get_template_directory_uri() . '/js/owl.js', array('jquery'), _S_VERSION, true);
    wp_enqueue_script('wow', get_template_directory_uri() . '/js/wow.js', array('jquery'), _S_VERSION, true);
    wp_enqueue_script('appear', get_template_directory_uri() . '/js/appear.js', array('jquery'), _S_VERSION, true);
    wp_enqueue_script('scrollbar', get_template_directory_uri() . '/js/scrollbar.js', array('jquery'), _S_VERSION, true);
